    ...
    <div className="container px-6 py-10 mx-auto">
        ...
        <section className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
            <div className="p-8 border rounded-lg dark:border-gray-700">
                <p className="leading-loose text-gray-500 dark:text-gray-400">Height: {height || "Not set"}</p>
                <p className="leading-loose text-gray-500 dark:text-gray-400">Weight: {weight || "Not set"}</p>
                <p className="leading-loose text-gray-500 dark:text-gray-400">Goals: {Object.keys(goals).filter(key => goals[key]).join(", ") || "Not set"}</p>
                <p className="leading-loose text-gray-500 dark:text-gray-400">My Momentum Fit Journey: {about || "Not set"}</p>
