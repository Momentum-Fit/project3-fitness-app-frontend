    ...
    <div className="user-profile-page">
      ...
      <section>
        <h2>Details</h2>
            ...
            <input type="text" value={weight} onChange={(e) => setWeight(e.target.value)} placeholder="weight"></input>
      </section>
        ...
        <div className="goals">
          <label>
            <input
              ...
              onChange={() => setGoals({ ...goals, weightLoss: !goals.weightLoss })}
            />
            Weight Loss
          </label>
          <label>
            <input
              ...
              onChange={() => setGoals({ ...goals, muscleGain: !goals.muscleGain })}
            />
            Muscle Gain
          </label>
          <label>
            <input
              ...
              onChange={() => setGoals({ ...goals, endurance: !goals.endurance })}
            />
            Endurance
          </label>
        </div>
        ...
        <div className="upload-section">
          ...
          {image && (
            <div className="image-preview">
              <h3>Image Preview:</h3>
              <img src={image} alt="Uploaded Progress" style={{ width: '300px', borderRadius: '8px' }} />
            </div>
          )}
        </div>
      </section>
      ...
      <section className="submit-section">
        <button onClick={() => alert('Profile updated successfully!')}>Save Profile</button>
      </section>
    </div>
  );
};
