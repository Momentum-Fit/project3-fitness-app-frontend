          ...
          <section className="bg-#E5E8EB dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
              ...
              <div className="my-plan-subheader">
                ...
                <div className="btns-myplan">
                  <button
                    id="update-plan-button"
                    onClick={openUpdatePopup}
                    className="flex items-center px-4 py-1 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80"
                  >
                    <svg
