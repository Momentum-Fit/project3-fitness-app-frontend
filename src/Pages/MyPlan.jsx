        ...
        <div className="container px-6 py-10 mx-auto">
          <div>
            ...
            >
              ...
              <span class="mx-1">Update My Plan</span>
            </button>
          ...
          >
            Your Plan:{" "}
            <span className="underline decoration-blue-500">{plan.name}</span>
          </h1>
          <div
            ...
            {exercises.map((exercise) => (
              ...
              >
                ...
                <p className="text-gray-500 dark:text-gray-300">
                  {exercise.details?.description || "No description available"}
                </p>
                <p className="text-gray-500 dark:text-gray-300">
                ...
                <p className="text-gray-500 dark:text-gray-300">
                  <strong>Difficulty:</strong> {exercise.details?.difficulty}
                </p>
              </div>
            ))}
          </div>
