          ...
          <div>
            ...
            <div class="flex items-center mt-6 gap-x-3">
              <button
                ...
                id="signup-btn"
                class="w-1/2 px-5 py-2 text-sm tracking-wide text-#404347 transition-colors duration-200 bg-#e9eef6 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600"
              >
                Sign Up
              </button>
              <button
